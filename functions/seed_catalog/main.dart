...
Future<void> main(List<String> args) async {
  ...
  try {
    ...
    final products = [
      {
        ...
        'category': 'froid',
        'price': 1500.0,
        'description': 'High-quality refrigerator with smart features',
        'active': true,
      },
      {
        'name': 'Electric Stove',
        'category': 'cuisson',
        'price': 2500.0,
        'description': 'Modern electric cooking stove',
        'active': true,
      },
    ];
    ...
    print('Categories created: $categoriesCreated');
    print('Products created: $productsCreated');
  } catch (e) {
    print('Error: $e');
  }
}
